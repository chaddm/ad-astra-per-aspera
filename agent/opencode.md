...
purpose:
  when-to-call:
    "When you need to modify .opencode configuration files for both per-project and
...
2. Add to the `./AGENTS.md` file the following:
   ...
   commands, tools, and themes. Use the skill `opencode-get-subagents` to get a list
   of available subagents and their purposes.
   ```
