...
managing and maintaining the GLOBAL configuration files, adding or modifying agents and
tools, and ensuring the integrity of the `opencode` setup.  Do not place
